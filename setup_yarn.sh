...
if [ "$NODE" == "master" ]; then
  ...
  # Start all: namenode, datanode, secondarynamenode, resourcemanager, nodemanager
  # $HADOOP_HOME/sbin/start-all.sh
  $HADOOP_HOME/bin/hdfs --daemon start namenode
  $HADOOP_HOME/bin/hdfs --daemon start secondarynamenode
  $HADOOP_HOME/bin/yarn --daemon start resourcemanager
  echo "Namenode started! URL: http://$(hostname -I | awk '{print $1}'):9870"
  echo "SecondaryNamenode started! URL: http://$(hostname -I | awk '{print $1}'):9868"
  echo "ResourceManager started! URL: http://$(hostname -I | awk '{print $1}'):8088"

  # Using HDFS for logging
  ...
  echo "Datanode started! URL: http://$(hostname -I | awk '{print $1}'):9864"
  echo "NodeManager started! URL: http://$(hostname -I | awk '{print $1}'):8042"
fi
